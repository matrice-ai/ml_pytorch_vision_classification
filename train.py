...
def main_worker(gpu, ngpus_per_node, args,actionTracker):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        loss_train,acc1_train, acc5_train =train(train_loader, model, criterion, optimizer, epoch, device, args)

        # evaluate on validation set
        loss_val,acc1_val,acc5_val,acc1= validate(val_loader, model, criterion, args)
